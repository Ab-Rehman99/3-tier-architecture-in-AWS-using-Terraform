...
variable "vpc_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "abdul-vpc", "created-by" = "terraform" }
}
...
variable "asg_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "abdul-asg-sg", "created-by" = "terraform" }
}
...
variable "asg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "abdul-asg", "created-by" = "terraform" }
}
...
variable "alb_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "abdul-alb-sg", "created-by" = "terraform" }
}
...
variable "alb_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "abdul-alb", "created-by" = "terraform" }
}
...
variable "rds_sg_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "abdul-rds-sg", "created-by" = "terraform" }
}
...
variable "rds_tags" {
  ...
  type        = map(string)
  default     = { "Name" = "abdul-rds", "created-by" = "terraform" }
}
